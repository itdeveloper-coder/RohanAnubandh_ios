...
$("#backButtonvideo").click(async function () {
    $("#youtubeIframe").attr("src", ""); // Stops video when tab is hidden
  });
...
//     var iframe = `<iframe width="100%" height="100%" src="${videoUrl}" frameborder="0" allow="encrypted-media" allowfullscreen></iframe>`;
//     $(this).html(iframe);
// });
