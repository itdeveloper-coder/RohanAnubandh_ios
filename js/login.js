...
$("#login_btn").click(function () {
    ...
    var vruserid = $("#login_text_userid").val().trim();
    var vrpassword = $("#login_text_password").val().trim();
...
$("#login_text_userid, #login_text_password").focus(function () {
    $(this).next(".error-message").hide(); // if you use span next to inputs
});
...
$(document).on('click', '.toggle-password', function () {
    ...
    $this.text(isVisible ? "visibility" : "visibility_off");
  });